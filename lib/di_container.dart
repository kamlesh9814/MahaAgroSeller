...
import 'package:maidc_seller/provider/article_provider.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:maidc_seller/data/repository/auth_repo.dart';
import 'package:maidc_seller/data/repository/business_repo.dart';
import 'package:maidc_seller/data/repository/cart_repo.dart';
...
import 'package:maidc_seller/data/repository/location_repo.dart';
import 'package:maidc_seller/data/repository/order_repo.dart';
import 'package:maidc_seller/data/repository/profile_repo.dart';
import 'package:maidc_seller/data/repository/refund_repo.dart';
import 'package:maidc_seller/data/repository/seller_repo.dart';
import 'package:maidc_seller/data/repository/shipping_repo.dart';
import 'package:maidc_seller/data/repository/shop_info_repo.dart';
import 'package:maidc_seller/data/repository/splash_repo.dart';
import 'package:maidc_seller/data/repository/bank_info_repo.dart';
import 'package:maidc_seller/data/repository/transaction_repo.dart';
import 'package:maidc_seller/provider/auth_provider.dart';
import 'package:maidc_seller/provider/business_provider.dart';
...
import 'package:maidc_seller/provider/emergency_contact_provider.dart';
import 'package:maidc_seller/provider/language_provider.dart';
import 'package:maidc_seller/provider/localization_provider.dart';
import 'package:maidc_seller/provider/bottom_menu_provider.dart';
...
import 'package:maidc_seller/provider/product_review_provider.dart';
import 'package:maidc_seller/provider/profile_provider.dart';
import 'package:maidc_seller/provider/refund_provider.dart';
...
Future<void> init() async {
  ...
  sl.registerLazySingleton(() => ArticleRepo(dioClient: sl()));

  // Provider
  sl.registerFactory(() => ArticleProvider(articleRepo: sl()));
