...
import 'package:maidc_seller/view/screens/shipping/widget/category_wise_shipping_card.dart';
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child:
                Consumer<ShippingProvider>(builder: (context, shipProv, child) {
              return Stack(
                children: [
                  Column(
                    children: [
                              ...
                              ? Expanded(
                                  ...
                                  child: ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        return CategoryWiseShippingCard(
                                            shipProv: shipProv,
                                            index: index,
                                            category: shipProv
