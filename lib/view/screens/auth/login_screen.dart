...
import 'package:maidc_seller/view/screens/auth/registration_screen.dart';
import 'package:maidc_seller/view/screens/dashboard/dashboard_screen.dart';
import 'package:maidc_seller/view/screens/forgetPassword/forget_password_screen.dart';
                          ...
                          onTap: () async {
                            ...
                            if (email.isEmpty) {
                              ...
                              authProvider
                                  ...
                                  .then((status) async {
                                log('status is here==>${status.response!.statusCode}');
