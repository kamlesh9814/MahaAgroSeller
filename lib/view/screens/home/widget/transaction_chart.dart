...
class TransactionChartState extends State<TransactionChart> {
  ...
  Widget build(BuildContext context) {
    return Consumer<BankInfoProvider>(builder: (context, bankInfoProvider, _) {
                  ...
                  LineChartData(
                    ...
                    maxX: double.parse(
                        (Provider.of<BankInfoProvider>(context, listen: false)
                                ...
                                .length)
                            .toString()),
                    maxY: (Provider.of<BankInfoProvider>(context, listen: false)
                            .lim /
  ...
  SideTitles get bottomTitles => SideTitles(
        showTitles: true,
        reservedSize: 32,
        interval: Provider.of<BankInfoProvider>(context, listen: false)
                    .revenueFilterTypeIndex ==
                1
            ? 4
            : 1,
  ...
  FlGridData get gridData =>
      FlGridData(show: true, drawVerticalLine: false, drawHorizontalLine: true);
