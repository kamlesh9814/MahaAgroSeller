...
import 'package:maidc_seller/data/model/response/review_model.dart';
...
import 'package:maidc_seller/view/base/rating_bar.dart';

class ProductReviewItem extends StatelessWidget {
  final ReviewModel reviewModel;
  const ProductReviewItem({Key? key, required this.reviewModel})
      : super(key: key);

  @override
  Widget build(BuildContext context) {
    String baseUrl =
        '${Provider.of<SplashProvider>(context, listen: false).configModel!.baseUrls!.customerImageUrl}';
    String review =
        '${Provider.of<SplashProvider>(context, listen: false).configModel!.baseUrls!.reviewImageUrl}';
    return Padding(
