...
import 'package:maidc_seller/data/model/response/shop_info_model.dart';
...
class ShopUpdateScreenState extends State<ShopUpdateScreen> {
  ...
  _updateShop() async {
    ...
    if (Provider.of<ShopProvider>(context, listen: false).shopModel!.name ==
            _shopNameController.text &&
        Provider.of<ShopProvider>(context, listen: false).shopModel!.contact ==
            _contactNumberController.text &&
        Provider.of<ShopProvider>(context, listen: false).shopModel!.address ==
            _addressController.text &&
        file == null &&
        Provider.of<AuthProvider>(context, listen: false).shopBanner == null &&
        Provider.of<AuthProvider>(context, listen: false).secondaryBanner ==
            null &&
        Provider.of<AuthProvider>(context, listen: false).offerBanner == null) {
      showCustomSnackBar(
      ...
      ShopModel updateShopModel =
          Provider.of<ShopProvider>(context, listen: false).shopModel!;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
        title: getTranslated('shop_settings', context),
      ),
      key: _scaffoldKey,
                                      ...
                                      ClipRRect(
                                          ...
                                          child: file == null
                                              ? CustomImage(
                                                  ...
                                                  width: 140,
                                                  image:
                                                      '${Provider.of<SplashProvider>(context, listen: false).baseUrls!.shopImageUrl}/${shop.shopModel!.image}')
                                              : Image.file(file!,
                                                  width: 100,
                                                  height: 100,
                                                  fit: BoxFit.cover)),
                                ...
                                ClipRRect(
                                    ...
                                    child: authProvider.shopBanner != null
                                        ...
                                        : SizedBox(
                                            ...
                                            child: CustomImage(
                                                image:
                                                    '${Provider.of<SplashProvider>(context, listen: false).baseUrls!.shopImageUrl}/banner/${shop.shopModel!.banner}'))),
                                Positioned(
                                  bottom: 0,
                                  right: 0,
                                  top: 0,
                                      ...
                                      ClipRRect(
                                        ...
                                        child: authProvider.secondaryBanner !=
                                            ...
                                            : SizedBox(
                                                ...
                                                child: CustomImage(
                                                    image:
                                                        '${Provider.of<SplashProvider>(context, listen: false).baseUrls!.shopImageUrl}/banner/${shop.shopModel!.bottomBanner}'),
                                              ),
                                      ),
                                      Positioned(
                                        bottom: 0,
                                        ...
                                        ClipRRect(
                                            ...
                                            child: authProvider.offerBanner != null
                                                ...
                                                : SizedBox(
                                                    ...
                                                    child: CustomImage(
                                                        image:
                                                            '${Provider.of<SplashProvider>(context, listen: false).baseUrls!.shopImageUrl}/banner/${shop.shopModel!.offerBanner}'))),
                                        Positioned(
                                          bottom: 0,
                                          right: 0,
                                          top: 0,
