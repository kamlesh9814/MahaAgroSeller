...
import 'package:maidc_seller/data/model/response/delivery_man_detail_model.dart'
    as d;
import 'package:maidc_seller/data/model/response/delivery_man_earning_model.dart';
import 'package:maidc_seller/data/model/response/delivery_man_model.dart';
import 'package:maidc_seller/data/model/response/delivery_man_order_history_model.dart';
import 'package:maidc_seller/data/model/response/delivery_man_review_model.dart';
import 'package:maidc_seller/data/model/response/delivery_man_withdraw_detail_model.dart';
import 'package:maidc_seller/data/model/response/delivery_man_withdraw_model.dart';
import 'package:maidc_seller/data/model/response/order_history_log_model.dart';
...
import 'package:maidc_seller/data/repository/delivery_man_repo.dart';
...
class DeliveryManProvider extends ChangeNotifier {
  ...
  Future<void> deliveryManListURI(int offset, String search,
    ...
    ApiResponse apiResponse =
        await deliveryManRepo!.deliveryManList(offset, search);
    if (reload) {
      _listOfDeliveryMan = [];
      _isLoading = true;
    }
    if (apiResponse.response != null &&
      ...
      _listOfDeliveryMan!.addAll(
          TopDeliveryMan.fromJson(apiResponse.response!.data).deliveryMan!);
    } else {
      ApiChecker.checkApi(apiResponse);
    }
    _isLoading = false;
  ...
  Future<void> getDeliveryManOrderListHistory(
      BuildContext context, int offset, int? deliveryManId,
      {bool reload = true}) async {
    ApiResponse apiResponse =
        await deliveryManRepo!.deliveryManOrderList(offset, deliveryManId);
    if (reload) {
    ...
    if (apiResponse.response != null &&
      ...
      _deliverymanOrderList.addAll(
          DeliveryManOrderHistory.fromJson(apiResponse.response!.data).orders!);
    } else {
      ApiChecker.checkApi(apiResponse);
    }
    _isLoading = false;
  ...
  Future<void> getDeliveryManEarningListHistory(
      BuildContext context, int offset, int? deliveryManId,
      {bool reload = true}) async {
    ApiResponse apiResponse =
        await deliveryManRepo!.deliveryManEarningList(offset, deliveryManId);
    if (reload) {
    ...
    if (apiResponse.response != null &&
      ...
      if (offset == 1) {
        _deliveryManEarning =
            DeliveryManEarning.fromJson(apiResponse.response!.data);
      } else {
        _deliveryManEarning!.totalSize =
            DeliveryManEarning.fromJson(apiResponse.response!.data).totalSize;
        _deliveryManEarning!.offset =
            DeliveryManEarning.fromJson(apiResponse.response!.data).offset;
        _deliveryManEarning!.orders!.addAll(
            DeliveryManEarning.fromJson(apiResponse.response!.data).orders!);
      }
    } else {
      ApiChecker.checkApi(apiResponse);
    }
  ...
  Future<void> getDeliveryManDetails(int? deliveryManId) async {
    _isLoading = true;
    ApiResponse apiResponse =
        await deliveryManRepo!.deliveryManDetails(deliveryManId);
    if (apiResponse.response != null &&
        apiResponse.response!.statusCode == 200) {
      _isLoading = false;
      _deliveryManDetails =
          d.DeliveryManDetails.fromJson(apiResponse.response!.data);
    } else {
      ApiChecker.checkApi(apiResponse);
    }
    _isLoading = false;
  ...
  Future<void> getDeliveryManOrderHistoryLogList(
    ...
    _isLoading = true;
    ApiResponse apiResponse =
        await deliveryManRepo!.getDeliverymanOrderHistoryLog(orderId);
    if (apiResponse.response != null &&
        apiResponse.response!.statusCode == 200) {
      _changeLogList = [];
  ...
  Future<void> assignDeliveryMan(
    ...
    ApiResponse apiResponse;
    apiResponse =
        await deliveryManRepo!.assignDeliveryMan(orderId, deliveryManId);
    if (apiResponse.response != null &&
        apiResponse.response!.statusCode == 200) {
  ...
  Future<void> collectCashFromDeliveryMan(
    ...
    notifyListeners();
    ApiResponse apiResponse;
    apiResponse = await deliveryManRepo!
  ...
  Future<ApiResponse> addNewDeliveryMan(
      BuildContext context, DeliveryManBody deliveryManBody,
      {bool isUpdate = false}) async {
    _isLoading = true;
    notifyListeners();
    ApiResponse response = await deliveryManRepo!.addNewDeliveryMan(
        _profileImage,
        _identityImages,
        deliveryManBody,
  ...
  Future<void> getDeliveryManWithdrawDetails(
    ...
    _isLoading = true;
    ApiResponse apiResponse =
        await deliveryManRepo!.deliveryManWithdrawDetails(id);
  ...
  Future<void> getDeliveryManWithdrawList(int offset, String status,
      {bool reload = true}) async {
    ApiResponse apiResponse =
        await deliveryManRepo!.deliveryManWithdrawList(offset, status);
    if (reload) {
      _withdrawList = [];
      _isLoading = true;
    }
  ...
  Future<void> getDeliveryManReviewList(
      ...
      {bool reload = true}) async {
    ApiResponse apiResponse =
        await deliveryManRepo!.getDeliveryManReviewList(offset, id);
    if (reload) {
  ...
  Future<void> getDeliveryCollectedCashList(
      BuildContext context, int? deliveryManId, int offset,
      {bool reload = true}) async {
    if (reload) {
    ...
    _isLoading = true;
    ApiResponse apiResponse = await deliveryManRepo!
