...
import 'package:maidc_seller/data/model/body/place_order_body.dart';
import 'package:maidc_seller/data/model/response/cart_model.dart';
import 'package:maidc_seller/data/model/response/temporary_cart_for_customer.dart'
    as customer;
...
import 'package:maidc_seller/view/base/custom_header.dart';
import 'package:maidc_seller/view/base/custom_snackbar.dart';
import 'package:maidc_seller/view/screens/pos/add_new_customer_screen.dart';
import 'package:maidc_seller/view/screens/pos/customer_search_screen.dart';
import 'package:maidc_seller/view/screens/pos/widget/cart_pricing_widget.dart';
import 'package:maidc_seller/view/screens/pos/widget/confirm_purchase_dialog.dart';
import 'package:maidc_seller/view/screens/pos/widget/coupon_apply_widget.dart';
import 'package:maidc_seller/view/screens/pos/widget/extra_discount_and_coupon_dialog.dart';
import 'package:maidc_seller/view/screens/pos/widget/item_card_widget.dart';
import 'package:maidc_seller/view/screens/pos/widget/pos_no_product_widget.dart';
...
class _PosScreenState extends State<PosScreen> {
  ...
  void initState() {
    super.initState();
    Provider.of<CartProvider>(context, listen: false).getCustomerList('all');
    Provider.of<CartProvider>(context, listen: false).clearCardForCancel();
        ...
        child: CustomScrollView(
          ...
          slivers: [
            SliverToBoxAdapter(child:
                Consumer<CartProvider>(builder: (context, cartController, _) {
              productDiscount = 0;
              total = 0;
              productTax = 0;
              subTotal = 0;
