...
class AddProductSeoScreenState extends State<AddProductSeoScreen> {
    ...
    if (isRoute) {
      if (_update) {
        if (thumbnailImage == '' && metaImage == '') {
          total = Provider.of<SellerProvider>(context, listen: false)
                  .withColor
                  .length +
              Provider.of<SellerProvider>(context, listen: false)
                  .withoutColor
                  .length;
        } else if (Provider.of<SellerProvider>(context, listen: false)
                .productReturnImage!
                .isEmpty &&
            metaImage == '') {
          total = 1;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                ...
                child: (resProvider.attributeList != null &&
                    ...
                    ? Column(
                        ...
                        children: [
                          ...
                          //                     if (kDebugMode) {
                          //                       print(
                          //                           'Here is your tag===>${tags.toList()}/${tagList.toList()}');
                          //                     }
                          //                     return Container(
                          ...
                          Row(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text(
                                    getTranslated(
                                        'product_seo_settings', context)!,
                                    style: robotoBold.copyWith(
                                        color: ColorResources.getHeadTextColor(
                                            context),
                                        fontSize:
                          ...
                          CustomTextField(
                            ...
                            maxLine: 3,
                            hintText:
                                getTranslated('meta_description_hint', context),
                          ),
                                  ...
                                  child: resProvider.pickedMeta != null
                                      ...
                                      : widget.product != null
                                          ? FadeInImage.assetNetwork(
                                              ...
                                              image:
                                                  '${Provider.of<SplashProvider>(context).configModel!.baseUrls!.productImageUrl}/meta/${_product!.metaImage ?? ''}',
                                              height: 120,
                                              width: 150,
                                              fit: BoxFit.cover,
                                      ...
                                      : widget.product != null
                                          ? FadeInImage.assetNetwork(
                                              placeholder:
                                                  Images.placeholderImage,
                                              image:
                                                  '${Provider.of<SplashProvider>(context).configModel!.baseUrls!.productThumbnailUrl}/${_product!.thumbnail ?? ''}',
                                              height: 120,
                                              width: 150,
                                              fit: BoxFit.cover,
                                              imageErrorBuilder: (c, o, s) =>
                          ...
                          if (resProvider.attributeList![0].active &&
                              resProvider.attributeList![0].variants.isNotEmpty)
                            GridView.builder(
                                gridDelegate:
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  if (resProvider.withColor[index].color !=
                                      null) {
                                    colorString =
      ...
      bottomNavigationBar:
          Consumer<SellerProvider>(builder: (context, resProvider, _) {
        return Container(
          height: 80,
                    ...
                    if (!_update && resProvider.pickedLogo == null) {
                      showCustomSnackBar(
                        ...
                        resProvider.withColor.length +
                            ...
                            0) {
                      showCustomSnackBar(
                          getTranslated('upload_product_image', context),
                          context);
                    } else {
                      _addProduct = AddProductModel();
                      ...
                      _product!.taxModel =
                          resProvider.taxTypeIndex == 0 ? 'include' : 'exclude';
                      _product!.unitPrice =
                          PriceConverter.systemCurrencyToDefaultCurrency(
                              double.parse(widget.unitPrice!), context);
                      _product!.purchasePrice =
                          PriceConverter.systemCurrencyToDefaultCurrency(
                              double.parse(widget.purchasePrice!), context);
                      _product!.discount = resProvider.discountTypeIndex == 0
                          ? double.parse(widget.discount!)
                          : PriceConverter.systemCurrencyToDefaultCurrency(
                              double.parse(widget.discount!), context);
                      _product!.productType = resProvider.productTypeIndex == 0
                          ? 'physical'
                          : 'digital';
                      _product!.unit = unit;
                      ...
                      _product!.shippingCost =
                          PriceConverter.systemCurrencyToDefaultCurrency(
                              double.parse(widget.shippingCost!), context);
                      ...
                      if (resProvider.subCategoryIndex != 0) {
                        _product!.categoryIds!
                            .add(CategoryIds(id: widget.subCategoryId));
                      }

                      if (resProvider.subSubCategoryIndex != 0) {
                        _product!.categoryIds!
                            .add(CategoryIds(id: widget.subSubCategoryId));
                      }
                        ...
                        if (resProvider.pickedLogo == null &&
                          ...
                          if (resProvider.pickedLogo != null) {
                            resProvider.addProductImage(
                                context, resProvider.thumbnail, route);
                          }

                          if (resProvider.pickedMeta != null) {
                            resProvider.addProductImage(
                                context, resProvider.metaImage, route);
                          }
                          ...
                          for (int i = 0;
                              ...
                              i++) {
                            resProvider.addProductImage(
                                context, resProvider.withColor[i], route);
                          }
                          for (int i = 0;
                              i < resProvider.withoutColor.length;
                              i++) {
                            resProvider.addProductImage(
                                context, resProvider.withoutColor[i], route);
                          }
                        }
                      }
                      if (resProvider.pickedLogo != null) {
