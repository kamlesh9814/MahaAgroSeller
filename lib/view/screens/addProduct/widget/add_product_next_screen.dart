...
import 'package:maidc_seller/data/model/response/attribute_model.dart';
import 'package:maidc_seller/data/model/response/product_model.dart';
import 'package:maidc_seller/data/model/response/variant_type_model.dart';
...
import 'package:maidc_seller/view/base/attribute_view.dart';
...
import 'package:maidc_seller/view/screens/addProduct/widget/add_product_seo_screen.dart';
...
class AddProductNextScreenState extends State<AddProductNextScreen> {
  ...
  void initState() {
    ...
    if (_update) {
      ...
      Provider.of<SellerProvider>(context, listen: false).setDiscountTypeIndex(
      ...
      _purchasePriceController.text = PriceConverter.convertPriceWithoutSymbol(
          context, _product!.purchasePrice);
                              ...
                              ? Column(
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        Text(
                                            getTranslated('add_color_variation',
                                                context)!,
                                    ...
                                    resProvider.attributeList![0].active
                                        ? Consumer<SplashProvider>(builder:
                                            (ctx, colorProvider, child) {
                                    ...
                                    SizedBox(
                                        height:
                                            resProvider.selectedColor.isNotEmpty
                                                ? Dimensions.paddingSizeSmall
                                                : 0),
                                    SizedBox(
                                      height: (resProvider.attributeList![0]
                                              .variants.isNotEmpty)
                                          ? 40
                                          : 0,
                                      child: (resProvider.attributeList![0]
                                              .variants.isNotEmpty)
                                          ? ListView.builder(
                            ...
                            children: [
                              ...
                              Expanded(
                                ...
                                children: [
                                  Text(
                                      getTranslated(
                                          'minimum_order_quantity', context)!,
                                      style: robotoRegular.copyWith(
                                          fontSize:
              ...
              return CustomButton(
                ...
                onTap: () {
                  ...
                  if (unitPrice.isEmpty) {
                    showCustomSnackBar(
                        getTranslated('enter_unit_price', context), context);
                  } else if (purchasePrice.isEmpty) {
                    showCustomSnackBar(
                        getTranslated('enter_purchase_price', context),
                        context);
                    ...
                    showCustomSnackBar(
                        getTranslated('enter_price_for_every_variant', context),
                        context);
                  } else if (blankVariantQuantity) {
                    showCustomSnackBar(
                        getTranslated(
                            'enter_quantity_for_every_variant', context),
                        context);
                  } else {
                    Navigator.push(
                        context,
