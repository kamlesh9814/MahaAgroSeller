...
import 'package:maidc_seller/view/base/custom_divider.dart';
import 'package:maidc_seller/view/screens/pos_printer/invoice_print.dart';
...
class _InVoiceScreenState extends State<InVoiceScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<ShopProvider>(builder: (context, shopController, _) {
        return SingleChildScrollView(
          child:
              Consumer<OrderProvider>(builder: (context, invoiceProvider, _) {
            if (invoiceProvider.invoice != null &&
                invoiceProvider.invoice!.orderAmount != null) {
              totalPayableAmount = invoiceProvider.invoice!.orderAmount! +
                  invoiceProvider.totalTaxAmount -
                  invoiceProvider.discountOnProduct -
                  invoiceProvider.invoice!.extraDiscount! -
                  invoiceProvider.invoice!.discountAmount!;
            }
            return Column(
              children: [
                Padding(
                              ...
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (_) => InVoicePrintScreen(
                                            ...
                                            discountProduct: invoiceProvider
                                                .discountOnProduct,
                ...
                Consumer<OrderProvider>(builder: (context, orderController, _) {
                  return orderController.invoice != null &&
                          orderController.invoice!.details != null &&
                          orderController.invoice!.details!.isNotEmpty
                      ? Padding(
                              ...
                              Row(
                                ...
                                children: [
                                  Text(
                                      ...
                                      style: robotoRegular),
                                  Text(
                                      '${getTranslated('paid_by', context)} ${getTranslated(invoiceProvider.invoice!.paymentMethod ?? 'cash', context)}',
                                      style: robotoRegular.copyWith(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    orderController
                                                        ...
                                                        ? Expanded(
                                                            child: Text(
                                                            '${orderController.invoice!.details![index].productDetails!.name} (${orderController.invoice!.details![index].variant ?? ''})',
                                                            maxLines: 2,
                                                            overflow:
                                                                TextOverflow
                                                                    .ellipsis,
                                                        ...
                                                        : Expanded(
                                                            child: Text(
                                                            '${orderController.invoice!.details![index].productDetails!.name}',
                                                            maxLines: 2,
                                                            overflow:
                                                                TextOverflow
                                                                    .ellipsis,
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                          '- ${PriceConverter.convertPrice(context, invoiceProvider.discountOnProduct)}'),
                                    ],
                                  ),
                                  const SizedBox(
                                      height: Dimensions.paddingSizeSmall),
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                          '- ${PriceConverter.convertPrice(context, orderController.invoice!.discountAmount)}'),
                                    ],
                                  ),
                                  const SizedBox(
                                      height: Dimensions.paddingSizeSmall),
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                          ' - ${PriceConverter.convertPrice(context, orderController.invoice!.extraDiscount)}'),
                                    ],
                                  ),
                                  const SizedBox(
                                      height: Dimensions.paddingSizeSmall),
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                          ' + ${PriceConverter.convertPrice(context, invoiceProvider.totalTaxAmount)}'),
                                    ],
                                  ),
                                  const SizedBox(
                                      height: Dimensions.paddingSizeSmall),
