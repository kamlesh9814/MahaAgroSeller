...
import 'package:maidc_seller/view/base/textfeild/custom_pass_textfeild.dart';
...
class DeliveryManInfo extends StatefulWidget {
  ...
  const DeliveryManInfo({Key? key, this.isPassword = false, this.deliveryMan})
      : super(key: key);
                        ...
                        child: DottedBorder(
                          ...
                          child: Stack(children: [
                              ...
                              child: deliveryManProvider.profileImage != null
                                  ...
                                  : widget.deliveryMan != null
                                      ? FadeInImage.assetNetwork(
                                          ...
                                          image:
                                              '${Provider.of<SplashProvider>(context).configModel!.baseUrls!.deliveryManImageUrl}/${widget.deliveryMan!.image ?? ''}',
                                          height: 150,
                                          width: 150,
                                          fit: BoxFit.cover,
                            ...
                            Positioned(
                              ...
                              child: InkWell(
                                onTap: () =>
                                    deliveryManProvider.pickImage(true, false),
                                child: Container(
                    ...
                    child: Container(
                      ...
                      child: DropdownButton<String>(
                        hint: deliveryManProvider.identityType == null
                            ? Text(
                                getTranslated('select_identity_type', context)!)
                            : Text(
