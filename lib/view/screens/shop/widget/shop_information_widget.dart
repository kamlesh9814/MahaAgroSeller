...
import 'package:maidc_seller/view/screens/shop/shop_update_screen.dart';
                            ...
                            children: [
                              Container(
                                  ...
                                  child: ClipRRect(
                                      ...
                                      child: CustomImage(
                                          image:
                                              '${Provider.of<SplashProvider>(context, listen: false).baseUrls!.shopImageUrl}/${resProvider!.shopModel?.image}'))),
                              const SizedBox(
