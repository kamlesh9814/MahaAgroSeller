...
import 'package:maidc_seller/view/screens/delivery/widget/delivery_man_earning_view_all_screen.dart';
import 'package:maidc_seller/view/screens/delivery/widget/delivery_man_earning_list_view.dart';
...
class _DeliveryManEarningListState extends State<DeliveryManEarningList> {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child:
          Consumer<DeliveryManProvider>(builder: (context, earningProvider, _) {
        ...
        return Column(
          children: [
            EarningItemCard(
                amount: earningProvider.deliveryManEarning?.totalEarn,
                title: 'total_earning',
                icon: Images.totalEarning),
            EarningItemCard(
                amount: earningProvider.deliveryManEarning?.withdrawableBalance,
