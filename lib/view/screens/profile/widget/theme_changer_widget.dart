      ...
      children: [
        ...
        Provider.of<SplashProvider>(context, listen: false)
            ...
            ? SectionItemWidget(
                ...
                onTap: () {
                  if (Provider.of<ShippingProvider>(context, listen: false)
                          .selectedShippingType ==
                      "category_wise") {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (_) => const CategoryWiseShippingScreen()));
                  } else if (Provider.of<ShippingProvider>(context,
                              listen: false)
                          .selectedShippingType ==
                      "order_wise") {
                    Navigator.of(context).push(MaterialPageRoute(
                    ...
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (_) => const ProductWiseShipping()));
                  }
                },
              )
            : const SizedBox(),
        ...
        SectionItemWidget(
          ...
          onTap: () => showAnimatedDialog(
              context, const SignOutConfirmationDialog(isDelete: true),
              isFlip: true),
        ),
      ],
    );
