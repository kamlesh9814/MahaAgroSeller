...
class AddEmergencyContact extends StatefulWidget {
  ...
  final int? index;
  const AddEmergencyContact({Key? key, this.index, this.contactList})
      : super(key: key);
...
class _AddEmergencyContactState extends State<AddEmergencyContact> {
  ...
  Widget build(BuildContext context) {
    return Dialog(child: Consumer<EmergencyContactProvider>(
            ...
            Padding(
              ...
              child: emergencyContactProvider.isLoading
                  ...
                  : CustomButton(
                      ...
                      onTap: () {
                        int? id = widget.contactList != null
                            ? widget.contactList!.id
                            : null;
