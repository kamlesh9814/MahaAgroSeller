...
import 'package:maidc_seller/data/model/response/month_model.dart';
import 'package:maidc_seller/data/model/response/transaction_model.dart';
import 'package:maidc_seller/data/model/response/year_model.dart';
...
class TransactionProvider extends ChangeNotifier {
  ...
  Future<void> getTransactionList(
    ...
    ApiResponse apiResponse =
        await transactionRepo!.getTransactionList(status, from, to);
