...
import 'package:maidc_seller/view/screens/chat/chat_screen.dart';
            ...
            ClipRRect(
              ...
              child: CachedNetworkImage(
                  ...
                  placeholder: (ctx, url) => Image.asset(
                      ...
                      fit: BoxFit.cover),
                  imageUrl:
                      '${Provider.of<SplashProvider>(context, listen: false).baseUrls!.deliveryManImageUrl}/${refundReq!.refundDetailsModel!.deliverymanDetails!.image}',
                  height: 50,
                  width: 50,
                  fit: BoxFit.cover),
            ),
            ...
            InkWell(
              onTap: () => Navigator.of(context).push(MaterialPageRoute(
                  builder: (_) => ChatScreen(
                      userId:
                          refundReq!.refundDetailsModel!.deliverymanDetails?.id,
                      name:
                          '${refundReq!.refundDetailsModel!.deliverymanDetails?.fName} ${refundReq!.refundDetailsModel!.deliverymanDetails?.lName}'))),
              child: Container(
                width: 50,
                height: 50,
                decoration: BoxDecoration(
