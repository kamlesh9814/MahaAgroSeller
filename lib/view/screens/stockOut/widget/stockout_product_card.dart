...
import 'package:maidc_seller/view/base/confirmation_dialog.dart';
...
import 'package:maidc_seller/view/screens/product/product_details.dart';
import 'package:maidc_seller/view/screens/shop/widget/bar_code_generator.dart';
import 'package:maidc_seller/view/screens/stockOut/widget/quantity_change_dialog.dart';
        ...
        child: Container(
          ...
          child: Stack(
            children: [
              ...
              Consumer<SellerProvider>(builder: (context, productProvider, _) {
                return Positioned(
                  bottom: 13,
                  right:
