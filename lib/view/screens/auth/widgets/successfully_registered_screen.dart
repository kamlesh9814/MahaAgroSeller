...
class SuccessfullyRegisteredScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
          title: getTranslated('shop_application_submission', context)),
      body: Column(
          ...
          children: [
            Padding(
              ...
              child:
                  SizedBox(width: 50, child: Image.asset(Images.successIcon)),
            ),
            Text(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(getTranslated('successfully', context)!,
