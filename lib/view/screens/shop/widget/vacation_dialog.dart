...
import 'package:maidc_seller/view/screens/shop/widget/vacation_calender.dart';
...
class VacationDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Dialog(
        ...
        child: Consumer<ShopProvider>(builder: (context, shop, _) {
          return SizedBox(
            width: 500,
            child: Padding(
                ...
                child: Column(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  InkWell(
                    onTap: () => showDialog(
                        context: context,
                        builder: (_) => const VacationCalender()),
                    child: Padding(
                      padding: const EdgeInsets.only(
