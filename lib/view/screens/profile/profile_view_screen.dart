...
import 'package:maidc_seller/view/screens/profile/profile_screen.dart';
import 'package:maidc_seller/view/screens/profile/widget/theme_changer_widget.dart';
        ...
        children: [
          ...
          Padding(
            ...
            child: !isMoney
                ...
                : Text(
                    '${Provider.of<SplashProvider>(context, listen: false).myCurrency!.symbol} ${NumberFormat.compact().format(double.parse(amount!))}',
