...
import 'package:maidc_seller/data/model/response/edt_product_model.dart';
...
import 'package:maidc_seller/view/screens/addProduct/widget/add_product_next_screen.dart';
import 'package:maidc_seller/view/screens/addProduct/widget/digital_product_widget.dart';
import 'package:maidc_seller/view/screens/addProduct/widget/select_category_widget.dart';
import 'package:maidc_seller/view/screens/addProduct/widget/title_and_description_widget.dart';
...
class AddProductScreenState extends State<AddProductScreen>
  ...
  void initState() {
    ...
    if (widget.product != null) {
      ...
      Provider.of<SellerProvider>(context, listen: false).productCode.text =
          widget.product!.code ?? '123456';
      Provider.of<SellerProvider>(context, listen: false)
          .getEditProduct(context, widget.product!.id);
      Provider.of<SellerProvider>(context, listen: false)
          .setValueForUnit(widget.product!.unit.toString());
      Provider.of<SellerProvider>(context, listen: false).setProductTypeIndex(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                        ...
                        child: Column(
                          children: [
                            ...
                            Padding(
                              ...
                              child:
                                  SelectCategoryWidget(product: widget.product),
                            ),
                            const SizedBox(
      ...
      bottomNavigationBar: Container(
        ...
        child: Consumer<SellerProvider>(builder: (context, resProvider, _) {
                  ...
                  child: InkWell(
                    onTap: () {
                      ...
                      if (haveBlankTitle) {
                        ...
                        showCustomSnackBar(
                            getTranslated(
                                'please_choose_digital_product', context),
                            context);
                      } else if (resProvider.categoryIndex == 0) {
                        showCustomSnackBar(
                            getTranslated('select_a_category', context),
                            context);
                        ...
                        showCustomSnackBar(
                          ...
                          resProvider.productCode.text.isEmpty) {
                        showCustomSnackBar(
                            getTranslated('product_code_is_required', context),
                            context);
                      } else if (resProvider.productCode.text.length < 6 ||
                          resProvider.productCode.text == '000000') {
                        showCustomSnackBar(
                            getTranslated(
                                'product_code_minimum_6_digit', context),
                            context);
                      } else {
